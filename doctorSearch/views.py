    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if(len(name) > 1): # method_2
                firstName = name[0] # method_2
                lastName = name[1] # method_2
            else: # method_2
                firstName = name[0] # method_2
                lastName = name[0] # method_2

            try: # method_2
                cursor = connection.cursor() # method_2
                sqlStatement = "SELECT id, first_name, last_name, department FROM doctorSearch_doctor WHERE first_name=\'"+firstName+"\' OR first_name=\'"+lastName+"\' OR last_name=\'"+firstName+"\' OR last_name=\'"+lastName+"\'" # method_2
